    ...
    */
    ...
    public function __construct(
        ...
        $dumpSettingsDefault = array(
            ...
            'compress' => FNYBackupMysqldump::NONE,
            'no-data' => array(),
            ...
            'skip-tz-utc' => false,
            'no-autocommit' => true,
            'default-character-set' => FNYBackupMysqldump::UTF8,
            'skip-comments' => false,
    ...
    private function exportTables()
    {
        ...
        foreach ($this->tables as $table) {
            ...
            $this->delegate->didDumpTable($table);
        }
    }
